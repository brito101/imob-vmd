...
<div class="main_slide d-none d-sm-block">
    <div class="container" style="height: 100%;">
        <div class="row align-items-center" style="height: 100%;">
            <div class="col-lg-8">
                <p class="main_slide_content text-opposit">Encontre o <span class="text-theme text-bold">Imóvel ideal</span> para você e sua família</p>
                <a href="{{ route('web.buy') }}" class="btn-custom text-opposit" style="font-size: 1.4rem;">Quero <b>Comprar</b>!</a>
                <a href="{{ route('web.rent') }}" class="btn-custom text-opposit" style="font-size: 1.4rem;">Quero <b>Alugar</b>!</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <form action="{{ route('web.filter') }}" method="post" class="form-inline w-100">
                ...
                <div class="form-group col-12 col-sm-6 mt-sm-2 mt col-lg-3 mt-lg-0">
                    <label for="type" class="mb-2 d-block text-back text-support"><b>Qual o tipo do imóvel?</b></label>
                    <select class="selectpicker input-large" id="type" name="filter_type" multiple data-actions-box="true" title="Escolha..." data-index="3" data-action="{{ route('component.main-filter.type') }}">
                        <option disabled>Selecione o filtro anterior</option>
                    </select>
                </div>
                <div class="form-group col-12 col-sm-6 mt-sm-2 col-lg-3 mt-lg-0">
                    ...
                    <select class="selectpicker" name="filter_neighborhood" id="neighborhood" title="Escolha..." data-index="4" data-action="{{ route('component.main-filter.neighborhood') }}" multiple
                ...
                <div class="col-12 mt-3 form_advanced text-decoration-none" style="display: none;">
                    ...
                    <div class="row">
                        <div class="form-group col-12 col-sm-6 mt-sm-2 col-lg-3 mt-lg-0">
                            ...
                            <select class="selectpicker" name="filter_bedrooms" data-index="5" data-action="{{ route('component.main-filter.bedrooms') }}" id="bedrooms" title="Escolha...">
                                <option disabled>Selecione o filtro anterior</option>
                            </select>
                        </div>
                ...
                <div class="col-6 mt-3">
                    <a href="" class="text-front open_filter text-decoration-none">Filtro avançado &downarrow;</a>
                </div>
...
<section class="main_properties py-5">
    <div class="container">
        <header class="d-flex justify-content-between align-items-center mb-5 flex-wrap">
            ...
            <a href="{{ route('web.buy') }}" class="badge badge-front p-2 text-opposit text-decoration-none text-bold">Ver mais</a>
        </header>
...
<section class="main_properties py-5 bg-light">
    <div class="container">
        <header class="d-flex justify-content-between align-items-center mb-5">
            ...
            <a href="{{ route('web.rent') }}"  class="badge badge-front p-2 text-opposit text-decoration-none text-bold">Ver mais</a>
        </header>
