...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="icon-home"></i>Novo Imóvel</h1>
                </div><!-- /.col -->
                                            ...
                                            <div class="label_gc bg-gradient-lightblue">
                                                ...
                                                <label class="label">
                                                    <input type="checkbox" name="sale"
                                                        {{ old('sale') == 'on' || old('sale') == true ? 'checked' : '' }}><span>Venda</span>
                                                </label>

                                                <label class="label">
                                                    <input type="checkbox" name="rent"
                                                        {{ old('rent') == 'on' || old('rent') == true ? 'checked' : '' }}><span>Locação</span>
                                                </label>
                                            </div>
                                                ...
                                                <label class="label">
                                                    ...
                                                    <select name="category" class="select2">
                                                        <option value="Imóvel Residencial"
                                                            {{ old('category') == 'Imóvel Residencial' ? 'selected' : '' }}>
                                                            Imóvel Residencial</option>
                                                        <option value="Comercial/Industrial"
                                                            {{ old('category') == 'Comercial/Industrial' ? 'selected' : '' }}>
                                                            Comercial/Industrial</option>
                                                        <option value="Terreno"
                                                            {{ old('category') == 'Terreno' ? 'selected' : '' }}>Terreno
                                                        </option>
                                                    </select>
                                                </label>
                                                ...
                                                <label class="label">
                                                    ...
                                                    <select name="type" class="select2">
                                                        <optgroup label="Imóvel Residencial">
                                                            <option value="Casa"
                                                                {{ old('type') == 'Casa' ? 'selected' : '' }}>Casa
                                                            </option>
                                                            <option value="Cobertura"
                                                                {{ old('type') == 'Cobertura' ? 'selected' : '' }}>
                                                                Cobertura</option>
                                                            <option value="Apartamento"
                                                                {{ old('type') == 'Apartamento' ? 'selected' : '' }}>
                                                                Apartamento</option>
                                                            <option value="Studio"
                                                                {{ old('type') == 'Studio' ? 'selected' : '' }}>Studio
                                                            </option>
                                                            <option value="Kitnet"
                                                                {{ old('type') == 'Kitnet' ? 'selected' : '' }}>Kitnet
                                                            </option>
                                                        </optgroup>
                                                        <optgroup label="Comercial/Industrial">
                                                            <option value="Sala Comercial"
                                                                {{ old('type') == 'Sala Comercial' ? 'selected' : '' }}>
                                                                Sala Comercial</option>
                                                            <option value="Depósito/Galpão"
                                                                {{ old('type') == 'Depósito/Galpão' ? 'selected' : '' }}>
                                                                Depósito/Galpão</option>
                                                            <option value="Ponto Comercial"
                                                                {{ old('type') == 'Ponto Comercial' ? 'selected' : '' }}>
                                                                Ponto Comercial</option>
                                                        </optgroup>
                                                        <optgroup label="Terreno">
                                                            <option value="Terreno"
                                                                {{ old('type') == 'Terreno' ? 'selected' : '' }}>Terreno
                                                            </option>
                                                        </optgroup>
                                                    </select>
                                                </label>
                                                    ...
                                                    <select name="broker" class="select2">
                                                        ...
                                                        @foreach ($brokers as $broker)
                                                            <option value="{{ $broker->id }}"
                                                                @if (old('broker') == $broker->id) {{ 'selected' }} @endif>
                                                                {{ $broker->name }} ({{ $broker->document }})</option>
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </label>
                                            ...
                                            <div class="label_g2">
                                                <label class="label">
                                                    ...
                                                    <select name="status" class="select">
                                                        <option value="1"
                                                            {{ old('status') == '1' ? 'selected' : '' }}>Disponível
                                                        </option>
                                                        <option value="0"
                                                            {{ old('status') == '0' ? 'selected' : '' }}>Indisponível
                                                        </option>
                                                    </select>
                                                </label>
                                            </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="air_conditioning"
                                                            {{ old('air_conditioning') == 'on' || old('air_conditioning') == true ? 'checked' : '' }}><span>Ar
                                                            Condicionado</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="bar"
                                                            {{ old('bar') == 'on' || old('bar') == true ? 'checked' : '' }}><span>Bar</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="library"
                                                            {{ old('library') == 'on' || old('library') == true ? 'checked' : '' }}><span>Biblioteca</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="barbecue_grill"
                                                            {{ old('barbecue_grill') == 'on' || old('barbecue_grill') == true ? 'checked' : '' }}><span>Churrasqueira</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="american_kitchen"
                                                            {{ old('american_kitchen') == 'on' || old('american_kitchen') == true ? 'checked' : '' }}><span>Cozinha
                                                            Americana</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="fitted_kitchen"
                                                            {{ old('fitted_kitchen') == 'on' || old('fitted_kitchen') == true ? 'checked' : '' }}><span>Cozinha
                                                            Planejada</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="pantry"
                                                            {{ old('pantry') == 'on' || old('pantry') == true ? 'checked' : '' }}><span>Despensa</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="edicule"
                                                            {{ old('edicule') == 'on' || old('edicule') == true ? 'checked' : '' }}><span>Edícula</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="office"
                                                            {{ old('office') == 'on' || old('office') == true ? 'checked' : '' }}><span>Escritório</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="bathtub"
                                                            {{ old('bathtub') == 'on' || old('bathtub') == true ? 'checked' : '' }}><span>Banheira</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="fireplace"
                                                            {{ old('fireplace') == 'on' || old('fireplace') == true ? 'checked' : '' }}><span>Lareira</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="lavatory"
                                                            {{ old('lavatory') == 'on' || old('lavatory') == true ? 'checked' : '' }}><span>Lavabo</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="furnished"
                                                            {{ old('furnished') == 'on' || old('furnished') == true ? 'checked' : '' }}><span>Mobiliado</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="pool"
                                                            {{ old('pool') == 'on' || old('pool') == true ? 'checked' : '' }}><span>Piscina</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="steam_room"
                                                            {{ old('steam_room') == 'on' || old('steam_room') == true ? 'checked' : '' }}><span>Sauna</span>
                                                    </label>
                                                </div>
                                                <div>
                                                    <label class="label">
                                                        <input type="checkbox" name="view_of_the_sea"
                                                            {{ old('view_of_the_sea') == 'on' || old('view_of_the_sea') == true ? 'checked' : '' }}><span>Vista
                                                            para o Mar</span>
                                                    </label>
                                                </div>
                                            </div>
                                                ...
                                                <label class="label">
                                                    ...
                                                    <select name="experience" class="select2">
                                                        ...
                                                        <option value="Alto Padrão"
                                                            {{ old('experience') == 'Alto Padrão' ? 'selected' : '' }}>
                                                            Alto Padrão</option>
                                                        <option value="De Frente para o Mar"
                                                            {{ old('experience') == 'De Frente para o Mar' ? 'selected' : '' }}>
                                                            De Frente para o Mar</option>
                                                        <option value="Condomínio Fechado"
                                                            {{ old('experience') == 'Condomínio Fechado' ? 'selected' : '' }}>
                                                            Condomínio Fechado</option>
                                                        <option value="Compacto"
                                                            {{ old('experience') == 'Compacto' ? 'selected' : '' }}>
                                                            Compacto</option>
                                                        <option value="Lojas e Salas"
                                                            {{ old('experience') == 'Lojas e Salas' ? 'selected' : '' }}>
