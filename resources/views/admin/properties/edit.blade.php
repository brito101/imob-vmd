                                    ...
                                    <div id="data">
                                        ...
                                        <label class="label">
                                            ...
                                            <select name="user" class="select2">
                                                ...
                                                <option value="{{ $user->id }}" @if(old('user') == $user->id) {{'selected'}} @else {{ ($user->id == $property->user ? 'selected' : '') }} @endif>{{ $user->name }} ({{ $user->document }})</option>
                                                @endforeach
                                            </select>
                                        </label>
                                                ...
                                                <div class="label_g4">
                                                    ...
                                                    <label class="label">
                                                        ...
                                                        <input type="tel" name="garage_covered"
                                                               placeholder="Quantidade de Garagem Coberta" value="{{ old('garage_covered') ?? $property->garage_covered }}"/>
                                                    </label>
        ...
        $('.image-set-cover').click(function (event) {
            ...
            $.post(button.data('action'), {}, function (response) {
                if (response.success === true) {
                    $('.property_image').find('a.bg-gradient-primary').removeClass('bg-gradient-primary').addClass('bg-gradient-secondary');
