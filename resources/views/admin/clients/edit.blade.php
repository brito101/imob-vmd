...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="icon-user-plus"></i>Editar Cliente</h1>
                </div><!-- /.col -->
                    ...
                    <div class="card">
                        ...
                        <div class="dash_content_app_box ">
                            <div class="nav m-2">
                                ...
                                <form class="app_form" action="{{ route('admin.clients.update', ['client' => $user->id]) }}"
                                            ...
                                            <div class="label_gc bg-gradient-lightblue">
                                                ...
                                                <label class="label">
                                                    <input type="checkbox" name="lessee"
                                                        {{ old('lessee') == 'on' || old('lessee') == true ? 'checked' : ($user->lessee == true ? 'checked' : '') }}><span>Vendedor/Locatário</span>
                                                </label>

                                                <label class="label">
                                                    <input type="checkbox" name="lessor"
                                                        {{ old('lessor') == 'on' || old('lessor') == true ? 'checked' : ($user->lessor == true ? 'checked' : '') }}><span>Comprador/Locador</span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="app_collapse">
                                                ...
                                                <div class="app_collapse_content d-none content_spouse">
                                                    ...
                                                    <div class="label_g2">
                                                        <label class="label">
                                                            ...
                                                            <select name="spouse_genre">
                                                                <option value="male"
                                                                    {{ old('spouse_genre') == 'male' ? 'selected' : ($user->spouse_genre == 'male' ? 'selected' : '') }}>
                                                                    Masculino
                                                                </option>
                                                                <option value="female"
                                                                    {{ old('spouse_genre') == 'female' ? 'selected' : ($user->spouse_genre == 'female' ? 'selected' : '') }}>
                                                                    Feminino
                                                                </option>
                                                                <option value="other"
                                                                    {{ old('spouse_genre') == 'other' ? 'selected' : ($user->spouse_genre == 'other' ? 'selected' : '') }}>
                                                                    Outros
                                                                </option>
                                                            </select>
                                                        </label>
                                                    ...
                                                    <div class="label_g2">
                                                        <label class="label">
                                                            <span class="legend">Data de Nascimento:</span>
                                                            <input type="tel" class="mask-date"
                                                    ...
                                                    <label class="label  text-muted">
                                                        <span class="legend">Empresa:</span>
                                                        <input type="text" name="spouse_company_work"
                                                            placeholder="Contratante"
                                                    ...
                                                    <div class="label_g2">
                                                        <label class="label">
                                                            ...
                                                            <input type="text" name="max_budget"
                                                                ...
                                                                value="{{ old('max_budget') ?? $user->max_budget }}" />
                                                        </label>
                                                    ...
                                                    <div class="label_g2">
                                                        <label class="label">
                                                            ...
                                                            <input type="text" name="entry_value"
                                                                ...
                                                                value="{{ old('entry_value') ?? $user->entry_value }}" />
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="app_collapse_content">
                                                    ...
                                                    <div class="companies_list text-muted">
                                                        @if (count($user->companies()->get()))
                                                            ...
                                                            @endforeach
                                                        @else
                                                            <div class="no-content mb-2">Não foram encontrados registros!
                                                            </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    @foreach ($user->properties()->get() as $property)
                                                        <div class="card">
                                                            <h5 class="card-header text-dark bg-gradient-light">
                                                                <span
                                                                    class="badge bg-gradient-lightblue">#{{ $property->id }}</span>
                                                                {{ $property->category }} - {{ $property->type }}
                                                                @if ($property->sale == true && !empty($property->sale_price))
                                                                    :: <span class="text-bold text-lightblue">Venda:</span>
                                                                    R$ {{ $property->sale_price }}
                                                                @endif

                                                                @if ($property->rent == true && !empty($property->rent_price))
                                                                    :: <span
                                                                        class="text-bold text-lightblue">Aluguel:</span> R$
                                                                    {{ $property->rent_price }}
                                                                @endif
                                                            </h5>
                                                            <div class="card-body">
                                                        ...
                                                        @if ($property = $contract->propertyObject()->first())
                                                            <div class="card">
                                                                <h5 class="card-header text-dark bg-gradient-light">
                                                                    ...
                                                                    @if ($property->sale == true && !empty($property->sale_price))
                                                                        :: <span
                                                                            class="text-bold text-lightblue">Venda:</span>
                                                                        R$ {{ $property->sale_price }}
                                                                    @endif

                                                                    @if ($property->rent == true && !empty($property->rent_price))
                                                                        :: <span
                                                                            class="text-bold text-lightblue">Aluguel:</span>
