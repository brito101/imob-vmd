...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="icon-money"></i>Editar Venda</h1>
                </div><!-- /.col -->
                    ...
                    <div class="card">
                        ...
                        <div class="dash_content_app_box ">
                            <div class="nav m-2">
                                ...
                                <form class="app_form" action="{{ route('admin.sales.update', ['sale' => $sale->id]) }}" method="post">
                                    @method('PUT')
                                    @csrf
                                                ...
                                                <select name="property" class="select2">
                                                    ...
                                                    @foreach ($properties as $property)
                                                        <option value="{{ $property->id }}"
                                                            @if (old('property') == $property->id) {{ 'selected' }} @elseif ($sale->property == $property->id) {{ 'selected' }} @endif>
                                            ...
                                            <div class="label_g2">
                                                <label class="label">
                                                    ...
                                                    <input type="tel" name="date_of_sale" class="mask-date"
                                                        ...
                                                        value="{{ old('date_of_sale') ?? $sale->date_of_sale }}" />
                                                </label>
