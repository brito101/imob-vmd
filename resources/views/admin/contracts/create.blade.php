...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="icon-file-text"></i>Novo Contrato</h1>
            </div><!-- /.col -->
                                                    ...
                                                    <div class="label_g2">
                                                        <label class="label">
                                                            ...
                                                            <input type="tel" name="sale_price" class="mask-money"
                                                                   placeholder="Valor de Venda" {{ (old('purpose')!= 'sale' ? 'disabled' : '') }}/>
                                                        </label>

                                                        <label class="label">
                                                            <span class="legend">Valor de Locação:</span>
                                                            <input type="text" name="rent_price" class="mask-money"
                                                                   placeholder="Valor de Locação" {{ (old('purpose') != 'rent' ? 'disabled' : '') }}/>
                                                        </label>
                                                    </div>
