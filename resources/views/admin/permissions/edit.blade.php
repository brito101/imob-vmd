...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"><i class="icon-lock"></i>Editar Permissão</h1>
            </div><!-- /.col -->
                ...
                <div class="card">
                    ...
                    <div class="dash_content_app_box">
                        <div class="dash_content_app_box_stage m-2">
                            <form action="{{ route('admin.permission.update', ['permission' => $permission]) }}" method="post" class="app_form" autocomplete="off">
                                @csrf
                                @method('PUT')
