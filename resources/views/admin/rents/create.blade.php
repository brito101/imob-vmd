...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="icon-file"></i>Nova Locação</h1>
                </div><!-- /.col -->
                    ...
                    <div class="card">
                        ...
                        <div class="dash_content_app_box ">
                            <div class="nav m-2">
                                ...
                                <form class="app_form" action="{{ route('admin.rents.store') }}" method="post">
                                    @csrf
                                            ...
                                            <div class="label_g4">
                                                <label class="label">
                                                    ...
                                                    <input type="tel" name="init_date" class="mask-date"
                                                        placeholder="Data de Início" value="{{ old('init_date') }}" />
                                                </label>

                                                <label class="label">
                                                    <span class="legend">*Data de Término:</span>
                                                    <input type="tel" name="end_date" class="mask-date"
                                                        placeholder="Data de Término" value="{{ old('end_date') }}" />
                                                </label>
