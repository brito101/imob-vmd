...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><i class="icon-user-plus"></i>Novo Corretor</h1>
                </div><!-- /.col -->
                <div class="col-sm-6 d-flex justify-content-end">
                    <ol class="breadcrumb  my-auto">
                        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.brokers.index') }}">Corretores</a></li>
                        <li class="breadcrumb-item active">Novo Corretor</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-gradient-dark">
                            <h5 class="card-title text-white"><i class="icon-pencil-square-o"></i>Dados do Corretor</h5>
                        ...
                        <div class="dash_content_app_box ">
                            <div class="nav m-2">
                                ...
                                <form class="app_form" action="{{ route('admin.brokers.store') }}" method="post"
                                        ...
                                        <div id="data">
                                            ...
                                            <div class="label_g2">
                                                <label class="label">
                                                    ...
                                                    <select name="genre">
                                                        <option value="male"
                                                            {{ old('genre') == 'male' ? 'selected' : '' }}>Masculino
                                                        </option>
                                                        <option value="female"
                                                            {{ old('genre') == 'female' ? 'selected' : '' }}>Feminino
                                                        </option>
                                                        <option value="other"
                                                            {{ old('genre') == 'other' ? 'selected' : '' }}>Outros
                                                        </option>
                                                    </select>
                                                </label>
