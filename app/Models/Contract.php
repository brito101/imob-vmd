...
class Contract extends Model {
    ...
    public function setPurposeAttribute($value) {
        if ($value == 'sale') {
            return $this->attributes['purpose'] = 'sale';
        } else {
            return $this->attributes['purpose'] = 'rent';
        }
    }
